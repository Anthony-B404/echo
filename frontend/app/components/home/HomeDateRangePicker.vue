...
const ranges = computed(() => [
  { label: t('components.home.dateRanges.last7Days'), days: 7 },
  { label: t('components.home.dateRanges.last14Days'), days: 14 },
  { label: t('components.home.dateRanges.last30Days'), days: 30 },
  { label: t('components.home.dateRanges.last3Months'), months: 3 },
  { label: t('components.home.dateRanges.last6Months'), months: 6 },
  { label: t('components.home.dateRanges.lastYear'), years: 1 },
]);
  ...
  <UPopover :content="{ align: 'start' }" :modal="true">
    ...
    >
      <span class="truncate">
        ...
        <template v-else> {{ t('common.placeholders.pickDate') }} </template>
      </span>
